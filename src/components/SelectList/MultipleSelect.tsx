          ...
          "
				...
				{options && (
					<ul
						...
						className="max-h-40  border border-slate-900 w-max py-1 absolute group-focus-within:visible shadow-md invisible bg-gray-600 rounded-md overflow-y-auto scrollbar-thin scrollbar-thumb-slate-800 scrollbar-track-transparent scrollbar-thumb-rounded-md"
					>
						{optionsList}
					</ul>
				)}
